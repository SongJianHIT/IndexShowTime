package tech.songjian.stock.security.config;
...
import tech.songjian.stock.security.filter.JwtAuthorizationFilter;
import tech.songjian.stock.security.filter.JwtLoginAuthenticationFilter;
import tech.songjian.stock.security.handler.AccessAnonymousEntryPoint;
import tech.songjian.stock.security.handler.StockAccessDeniedHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public JwtLoginAuthenticationFilter jwtCustomLoginFilter() throws Exception {
        ...
        JwtLoginAuthenticationFilter jwtCustomLoginFilter =
                new JwtLoginAuthenticationFilter("/api/login");
        //注册认证管理器
